<template>
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" :stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="feature-icon-svg" aria-hidden="true">
